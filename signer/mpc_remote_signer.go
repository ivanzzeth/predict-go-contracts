...
func (s CoboMpcSigner) PersonalSign(data string) ([]byte, error) {
	...
	signDestination := coboWaas2.NewEvmEIP191MessageSignDestination(coboWaas2.MESSAGESIGNDESTINATIONTYPE_EVM_EIP_191_SIGNATURE, dataBase64)
